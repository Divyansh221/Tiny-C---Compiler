...
%token _BOOL _COMPLEX _IMAGINARY SIGNED UNSIGNED AUTO REGISTER
%token TYPEDEF EXTERN STATIC INLINE ENUM
%token CHAR SHORT INT LONG DOUBLE CONST VOLATILE VOID FLOAT 
%token RESTRICT UNION SIZEOF STRUCT 
%token ARROW INCREMENT DECREMENT RSHIFT LSHIFT LEQ GEQ EQ NEQ OR AND DOTS MULT MINUS
